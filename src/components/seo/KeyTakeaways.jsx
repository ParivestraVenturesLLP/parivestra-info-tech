export default function KeyTakeaways({ points = [], topic = '' }) {
  return (
    <aside
      className="key-takeaway bg-indigo-500/8 border border-indigo-500/20 rounded-2xl p-6 mb-8"
      ...
      <ul className="space-y-3">
        {points.map((point, i) => (
          <li key={i} className="flex items-start gap-3">
            <span className="shrink-0 w-5 h-5 rounded-full bg-indigo-500/20 border border-indigo-500/25 flex items-center justify-center mt-0.5">
